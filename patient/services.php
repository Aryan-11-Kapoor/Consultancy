...
<body>
    ...
    $stmt->execute();
    /* $result = $stmt->get_result(); //USERROW
    ...
    <tr class="menu-row">
        <td class="menu-btn menu-icon-services menu-active menu-icon-services-active">
            <a href="services.php" class="non-style-link-menu non-style-link-menu-active">
                <div>
                    <p class="menu-text">Our Services</p>
            </a></div>
        </td>
    </tr>
        ...
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
            <tr>
                ...
                <td>
                    <form action="" method="post" class="header-search">
                        ...
                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search for a service" list="doctors" value="<?php echo $insertkey ?>">&nbsp;&nbsp;
            ...
            <tr>
                <td colspan="4" style="padding-top:10px;width: 100%;">
                    <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)"><?php echo $searchtype . " Services" . "(" . $result->num_rows . ")"; ?> </p>
                                        ...
                                        <td style="width: 25%;">
                                                <div  class="dashboard-items search-items"  >
                                                    ...
                                                    <div style="width:100%">
                                                            ...
                                                            <br>
                                                            <a href="bionic.php" ><button  class="login-btn btn-primary-soft btn "  style="padding-top:11px;padding-bottom:11px;width:100%"><font class="tn-in-text">BIONIC READING</font></button></a>
                                                    </div>
...
<script>
    ...
    // window.open(url,"C:\\Users\\aryan\\OneDrive\\Desktop\\CAPSTONE\\bionic-reading-generator-gh-pages\\bionic.html"); // will open new tab on window.onload
    //}
</script>*/