    ...
    <div class="container">
        <div class="menu">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-servicess">
                        <a href="services.php" class="non-style-link-menu"><div><p class="menu-text">Our Services</p></a></div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>At Focus1ST we help you regain focus and control over your day to day activities with the help of our specialists.
                            ...
                            <h3>Connect with our specialists here</h3>
